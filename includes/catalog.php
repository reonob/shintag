<?php
	...
	$smarty->assign('select_tyres_width', get_select_from_table($db, 'tyres_width', true, 'min'));
	$smarty->assign('select_tyres_height', get_select_from_table($db, 'tyres_height', true, 'min'));
	$smarty->assign('select_tyres_radius', get_select_from_table($db, 'tyres_radius', true, 'min'));
